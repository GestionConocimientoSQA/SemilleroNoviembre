...
public class ProductsPagePage extends PageObject {
    private final By LABEL_NAMEPRODUCT = By.xpath("//div[@id = 'gallery-layout-container']//h3/span");
    ...
    public static void updateBTN_ADDCART(String productName) {
        BTN_ADDCART = By.xpath("(//div[@id = 'gallery-layout-container']//h3/span[text()='" + productName + "']/ancestor::article//button)[last()]");
    }
}
